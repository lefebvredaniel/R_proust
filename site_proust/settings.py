"""
Django settings for site_proust project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'/home/daniellefebvre/Rproust/accounts/templates/accounts/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'site_proust.wsgi.application'
...
DATABASES = {
      'default': {
            ...
            'NAME': 'daniellefebvre$digressions_db',
           'USER': 'daniellefebvre',
